...
(function($){
	...
	var methods = {
		...
		"init" : function( options ){
			...
			settings.toolbar = $.extend({}, defaults.toolbar, options.toolbar);
		...
		"_initButtons" : function(){
			...
			var pos = 6;
			for (var button in settings.toolbar) {
				$(titlebar).append('<a class="ui-dialog-titlebar-' + button + ' ui-corner-all" href="#" title=\"' + settings.toolbar[button].title + '\"><span class="ui-icon '+settings.toolbar[button].icon+'">'+ button + '</span></a>')
					.find(".ui-dialog-titlebar-" + button)
						...
						.css({ "right" : "{0}em".format(pos) })
						.click(settings.toolbar[button].event)
						;
				pos += 1.1;
			}
			...
			$(titlebar).find(".ui-dialog-titlebar-maximize,.ui-dialog-titlebar-minimize,.ui-dialog-titlebar-restore")
					.attr("role", "button")
					.mouseover(function(){ $(this).addClass("ui-state-hover"); })
					.mouseout(function(){ $(this).removeClass("ui-state-hover"); })
					.focus(function(){ $(this).addClass("ui-state-focus"); })
		...
		"_initStyles" : function(){
			...
			for (var button in settings.toolbar) {
				style += '.ui-dialog .ui-dialog-titlebar-' + button + ",";
			}
			...
			for (var button in settings.toolbar) {
				style += '.ui-dialog .ui-dialog-titlebar-' + button + ' span,';
			}
			...
			for (var button in settings.toolbar) {
				style += '.ui-dialog .ui-dialog-titlebar-' + button + ':hover,';
				style += '.ui-dialog .ui-dialog-titlebar-' + button + ':focus,';
			}
